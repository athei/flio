...
fn smb1_negot_req_smb2plus() {
    ...
    assert_eq!(header.flags, Flags::CANONICALIZED_PATHS | Flags::CASE_INSENSITIVE);
    assert_eq!(header.flags2, Flags2::SMB_SECURITY_SIGNATURE_REQUIRED | Flags2::LONG_NAMES | Flags2::EAS | Flags2::EXTENDED_SECURITY | Flags2::UNICODE | Flags2::IS_LONG_NAME | Flags2::EXTENDED_SECURITY | Flags2::NT_STATUS);
...
fn smb1_negot_req_not_supported() {
    ...
    assert_eq!(header.status, 0);
    assert_eq!(header.flags, Flags::CANONICALIZED_PATHS | Flags::CASE_INSENSITIVE);
    assert_eq!(header.flags2, Flags2::LONG_NAMES | Flags2::EAS | Flags2::EXTENDED_SECURITY | Flags2::UNICODE | Flags2::IS_LONG_NAME | Flags2::EXTENDED_SECURITY | Flags2::NT_STATUS);
